"""
Figure 3b. Three-mode comparison (Safest / Balanced / Fastest) — 서울관악초 case.

Same theme/colors/layout as fig03; only the origin and destination differ.
...
Case:
    Origin      : 예시 지점 (37.485486, 126.949675)
    Destination : 서울관악초 정문 (37.481022, 126.943335)

Output:
    figures/fig03b_route_comparison.pdf
    figures/fig03b_route_comparison.png
"""
...
BASEMAP_CACHE = CACHE_DIR / "fig03b_cartodb_positron_z17.tif"
PLOT_CRS = "EPSG:5186"

SCHOOL = "서울관악초등학교"
ORIGIN_LABEL = "출발지(예시)"
DEST_LABEL = "서울관악초 정문"
ORIGIN_LATLON = (37.483632, 126.936660)
DEST_LATLON = (37.481022, 126.943335)
SNAP_MAX_M = 300.0
...
def main() -> None:
    ...
    fastest_edges = route_edge_keys(routes["fastest"].path)
    balanced_edges = route_edge_keys(routes["balanced"].path)
    # 균형 경로가 안전/빠름 중 어느 쪽과 겹치든 오프셋해 항상 보이게 한다
    balanced_overlap = balanced_edges & (safest_edges | fastest_edges)
    ...
    pdf_path = OUT_DIR / "fig03b_route_comparison.pdf"
    png_path = OUT_DIR / "fig03b_route_comparison.png"
